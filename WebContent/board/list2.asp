...
'----------------------------------------------------------------------------
	...
	'response.write sql & "<br>" & boardcode
	'response.end
...
<table width="583" border="0" cellspacing="0" cellpadding="0" bgcolor="#f3f3f3">
  <tr>
	...
	<td width="301" align="right"><br>
		...
		<form name="form1" method="post" action="list.asp" ID="Form1">
		<tr>
...
<input type="hidden" name="ListUrl" value="/comm/Club/ClubBoard.asp">
<!--추가 E  KSH-->
...
<!--추가 E  KSH-->
  ...
  <tr>
	<td height="1" colspan="7" bgcolor="D6D7D6"></td>
  </tr>
