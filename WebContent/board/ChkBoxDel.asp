...
<%
	Select_Val = Request("selectlist[]")
	boardcode = request("boardcode")

	If InStr(Select_Val, ",") Then '// 다수 일때
		SplitSelect_Val = Split(Select_Val, ",")

		For loop_int = 0 To UBound(SplitSelect_Val)
			idx = Trim(SplitSelect_Val(loop_int))
