...
<div class="f_wrap line bb p8">
	...
	<div class="f_wrap line bb p8">
		<div class="f_field div1">
			...
			<div class="ff_wrap ml120 h30">
				<div class="area mt10">
					<c:if test="${requestScope.boardRow.bbs_name != ''}"><input type="hidden" name="bbs_name" class="input t1 w200" id="bbs_name" value="${requestScope.boardRow.bbs_name}"> ${requestScope.boardRow.bbs_name} </c:if> 
					<c:if test="${requestScope.boardRow.bbs_name == ''}"><input type="hidden" name="bbs_name" class="input t1 w200" id="bbs_name" value="${g_pers_name}"> ${g_pers_name} </c:if>
				</div>
			</div>
		</div>
	</div>
