...
<script type="text/javascript">
	...
	function doIpinCheckComplete()
	{
		...
		document.location.href = "/work/education/ke_trainees_join_step1.do";
	}
	...
	function MJoin(frm){
		...
		document.mobileJoin.action = "/work/education/ke_trainees_join_step1.do";
...
<div class="s_page">
	...
	<div class="sp_body">
		...
		<div class="area mt50">
			<h4 class="title bold t2 cm s1 i_b_t2">교육신청 절차</h4><span class="ib mt10 ml10 text small ca">  교육생 등록과 교육신청은 다음과 같은 순서에 따라 진행됩니다. </span>
		</div>
