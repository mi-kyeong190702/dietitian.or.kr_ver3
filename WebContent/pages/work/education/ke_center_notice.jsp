...
<div class="s_page">
	...
	<div class="sp_body">
		<div class="tab t2 div3 mb30">
			<ul>
				<li><a href="/work/education/ke_center_notice.do?bbs_board_code=2&bbs_category=교육&g_userid=<%=edu_userid%>" class="on">공지사항</a></li>
				<li><a href="/work/education/faq/faq_list.do?faq_category=2&g_userid=<%=edu_userid%>">FAQ</a></li>
				<li><a href="/work/education/ke_center_edu.do?bbs_board_code=116&g_userid=<%=edu_userid%>">교육후기</a></li>
			</ul>
		</div>	
