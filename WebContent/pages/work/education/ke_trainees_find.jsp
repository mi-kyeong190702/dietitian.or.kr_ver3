...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">교육생</mark>로그인</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/education/ke_join_edu.do" class="cm">교육생 로그인</a></li>
			</ul>
		</div>
	</div>
	<hr />
			...
			<div class="form">
				...
				<div class="f_wrap line bb p8">
					<div class="f_field div1">
						...
						<div class="ff_wrap ml120">
							<div class="area">
								<input type="text" class="input t1 fl w200" name="pers_birth" maxlength="8" onkeydown="checkDigit(this, 8)"/>
				...
				<div class="f_wrap line bb p8">
					<div class="f_field div1">
						...
						<div class="ff_wrap ml120">
							<div class="area">
								<input type="text" class="input t1 fl w200" name="pers_hp" size="20" onkeydown="checkDigit(this, 20)"/>
			...
			<div class="form">
				...
				<div class="f_wrap line bb p8">
					<div class="f_field div1">
						...
						<div class="ff_wrap ml120">
							<div class="area">
								<input type="text" class="input t1 fl w200" name="uname" id="uname" size="24" />
							</div>
						</div>
					</div>
				</div>
				<div class="f_wrap line bb p8">
					<div class="f_field div1">
						...
						<div class="ff_wrap ml120">
							<div class="area">
								<input type="text" class="input t1 fl w200" name="pers_birth" id="pers_birth"  onkeydown="checkDigit(this, 8)" size="10" maxlength="8" />
								<p class="fl text cp ml10">(예: 19800101과 같이 숫자만 입력)</p>
							</div>
						</div>
					</div>
