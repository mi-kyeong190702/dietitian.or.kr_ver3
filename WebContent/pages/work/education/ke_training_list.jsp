...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">교육생</mark> 교육현황</h3>
		</div>
		<div class="sp_navi">
			<ul>
                ...
                <li><a href="/work/education/ke_training_list.do">교육생 교육현황</a></li>
			</ul>
		</div>
	</div>
	<hr/>
	<div class="sp_body">
		...
		<table class="table t1 text s1 ca center mt20">
			...
			<c:choose>
				...
				<c:otherwise>
					<tr>
						<td colspan="5">교육 현황 목록이 없습니다. </td>
					</tr>
				</c:otherwise>
			</c:choose>
			</tbody>
