...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">어린이∙사회복지급식관리지원센터 </mark> 질문답하기</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/department/ka_child_notice.do?bbs_board_code=183&g_userid=<%=work_userid%>" class="cm">질문답하기</a></li>
			</ul>
		</div>
	</div>
	<hr />
