...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">영양교사</mark> 학교식단</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/department/ka_kda_edu.do?bbs_board_code=136&g_userid=<%=work_userid%>" class="cm">학교식단</a></li>
			</ul>
		</div>
	</div>
	<hr />
	<div class="sp_body">
		<div class="tab t1 div2 mb30">
			<ul>
				<li class="kb_main"><a href="./ka_kda_edu.do?bbs_board_code=136&g_userid=<%=work_userid%>" <% if( "136".equals(codes) ) { %> class="on" <% } %>>식단</a>
				</li>
				<li class="kb_man"><a href="./ka_kda_edu.do?bbs_board_code=137&g_userid=<%=work_userid%>" <% if( "137".equals(codes) ) { %> class="on" <% } %>>레시피</a>
				</li> 
			</ul>
		</div> 
	<!-- 
