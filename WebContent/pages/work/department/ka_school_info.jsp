...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">학교영양사</mark> 정보나눔방</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/department/ka_school_info.do?bbs_board_code=155&g_userid=<%=work_userid%>" class="cm">정보나눔방</a></li>
			</ul>
		</div>
	</div>
	<hr />
