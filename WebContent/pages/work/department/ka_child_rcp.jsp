...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">어린이∙사회복지급식관리지원센터 </mark> 식단 및 레시피</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/department/ka_child_rcp.do?bbs_board_code=182&g_userid=<%=work_userid%>" class="cm">식단 및 레시피</a></li>
			</ul>
		</div>
	</div>
	<hr />
