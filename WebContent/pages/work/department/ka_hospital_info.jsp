...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">병원</mark> 전문영양사모임</h3>
		</div>
		<div class="sp_navi">
			<ul>
				<li class="start"><a href="/index.jsp" class="icon_home"><span class="ti">HOME</span></a></li>
				<li><a href="/work/department/ka_club.do">분과별 게시판</a></li>
				<li><a href="/work/department/ka_hospital_notice.do?bbs_board_code=128&g_userid=<%=work_userid%>" >병원</a></li>
				<li><a href="/work/department/ka_hospital_info.do?bbs_board_code=130&g_userid=<%=work_userid%>" class="cm">전문영양사모임</a></li>
			</ul>
		</div>
	</div>
	<hr />
