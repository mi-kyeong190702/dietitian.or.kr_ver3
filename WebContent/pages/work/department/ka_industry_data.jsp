...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">산업체</mark> 자료실</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/department/ka_industry_data.do?bbs_board_code=125&g_userid=<%=work_userid%>" class="cm">자료실</a></li>
			</ul>
		</div>
	</div>
	<hr />
