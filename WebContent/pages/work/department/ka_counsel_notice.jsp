...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">건강상담</mark> 공지사항</h3>
		</div>
		<div class="sp_navi">
			<ul>
				<li class="start"><a href="/index.jsp" class="icon_home"><span class="ti">HOME</span></a></li>
				<li><a href="/work/department/ka_club.do">분과별 게시판</a></li>
				<li><a href="/work/department/ka_counsel_notice.do?bbs_board_code=175&g_userid=<%=work_userid%>" >건강상담</a></li>
				<li><a href="/work/department/ka_counsel_notice.do?bbs_board_code=175&g_userid=<%=work_userid%>" class="cm">공지사항</a></li>
			</ul>
		</div>
	</div>
	<hr />
