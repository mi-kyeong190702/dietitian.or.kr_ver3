...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">병원</mark> 공지사항</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/department/ka_hospital_notice.do?bbs_board_code=128&g_userid=<%=work_userid%>" class="cm">공지사항</a></li>
			</ul>
		</div>
	</div>
	<hr />
