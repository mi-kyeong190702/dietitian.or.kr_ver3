...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">학교영양사</mark> 식단 및 레시피</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/department/ka_school_rcp.do?bbs_board_code=156&g_userid=<%=work_userid%>" class="cm">식단 및 레시피</a></li>
			</ul>
		</div>
	</div>
	<hr />
