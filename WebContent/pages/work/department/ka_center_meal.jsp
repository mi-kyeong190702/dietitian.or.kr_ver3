...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">보건복지시설</mark> 급식운영</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/department/ka_center_meal.do?bbs_board_code=173&g_userid=<%=work_userid%>" class="cm">급식운영</a></li>
			</ul>
		</div>
	</div>
	<hr />
