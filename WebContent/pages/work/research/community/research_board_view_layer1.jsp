...
<div class="box t3 text ssmall">
	<ul class="area">
		...
		<c:if test="${boardRow.atc_impatc_yn == 'Y'}">
		<li class="bgw">
			<div class="p10 pl15">
				<strong class="ib w100 bold cm">중요공지기능</strong>
				<span>중요공지</span>
			</div>
		</li>
		<li class="bgw">
			<div class="p10 pl15">
				<strong class="ib w100 bold cm">중요공지기간</strong>
				<span>${boardRow.atc_impatc_bgn_dttm} ~ ${boardRow.atc_impatc_end_dttm}</span>
			</div>
		</li>
		</c:if>
...
<div class="line bb p30 text">
	<h4 class="ti">본문</h4>
		<iframe name="bbs_contents" width="682" scrolling="no" src="/research_board_view_contents.do?bbs_cd=001&atc_sno=${requestScope.boardRow.atc_sno}" onload="javascript:setIFrameHeight(this)"></iframe>
	<br>
</div>
