...
<c:if test="${null eq statusVo}">
	<c:if test="${null eq loginVo}">
		<script type="text/javascript"> 
			...
			location.href="/work/research/recipient/kr_recipient_check.do";
		</script>
	</c:if>
</c:if>
			...
			<div class="f_field div1">
				<div class="ff_wrap">
					<div class="area">
						...
						<select name="inputid2" class="select t2 fl w150" id="inputid2">
						...
						<input type="text" class="input t1 fl w200 ml5" id="inputid3" />
