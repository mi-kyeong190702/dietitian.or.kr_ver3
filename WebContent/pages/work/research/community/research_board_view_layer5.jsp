...
<div class="line bb p30 text">
	<h4 class="ti">본문</h4>
		<iframe name="bbs_contents" width="682" scrolling="no" src="/research_board_view_contents.do?bbs_cd=005&atc_sno=${requestScope.boardRow.atc_sno}" onload="javascript:setIFrameHeight(this)"></iframe>
	<br>
</div>
