...
<div class="box t3 text ssmall">
	<ul class="area">
		...
		<li class="fl w50p bgw line">
			<div class="p10 pl15">
				<strong class="ib w100 bold cm">등록일</strong>
				<span>${f:substring(boardRow.frst_rgt_dttm, 0, 10)}</span>
			</div>
		</li>
	</ul>
</div>
<div class="line bb p30 text">
	<h4 class="ti">본문</h4>
		<iframe name="bbs_contents" width="682" scrolling="no" src="/research_board_view_contents.do?bbs_cd=003&atc_sno=${requestScope.boardRow.atc_sno}" onload="javascript:setIFrameHeight(this)"></iframe>
	<br>
</div>
			...
			<div class="box t3 mt30 text ssmall">
				<ul class="area">
					...
					<li class="fl w33p bgw line">
						<div class="p10 pl15">
							<strong class="ib w100 bold cm">등록일</strong>
							<span>${f:substring(replyRow[i].frst_rgt_dttm, 0, 10)}</span>
						</div>
					</li>
				</ul>
			</div>
