               ...
               /* 리턴 값 모두 찍어보기 (테스트 시에만 사용) */
                ...
                for ( i = 0 ; i < frm.length ; i++ )
                {
               	...
               	if(frm.res_cd.value=="0000"){
               		var ff = opener.document.forms["report"];
               		var voF = opener.document.forms["actulpersonVo"];
               		
               		if(form_value == voF.pers_name.value) {
               			ff.step.value= "step3";
    	    			ff.method = "POST";
    	    			ff.submit();
    	    			alert("인증이 완료 되었습니다.");
    	    			self.close();	
               			...
               			alert("입력하신 이름과 휴대폰정보가 일치하지 않습니다.\r\n다시 확인하시고, 정확히 입력해 주시기 바랍니다.");
    	        		self.close();
               		}
               	}else{
	        		alert("인증실패");
    ...
    <body oncontextmenu="return false;" ondragstart="return false;" onselectstart="return false;">
        <div align="center">
            <form name="form_auth">
                ...
                <input type="hidden" name="Ret_URL"      value="https://www.dietitian.or.kr/pages/work/research/report/kcpcert_proc_req.jsp" />
