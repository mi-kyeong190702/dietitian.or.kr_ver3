...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<c:choose>
			...
			<div class="s_page">
				<div class="sp_head">
					<div class="sp_title">
						<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">보수교육</mark> 현황</h3>
					</div>
					<div class="sp_navi">
						<ul>
							...
							<li><a href="/work/research/mypage/km_education.do" class="cm">보수교육 현황</a></li>
						</ul>
					</div>
				</div>
				<hr />
				<div class="sp_body">
					<c:import url="/research_mypage_education.do"></c:import>
				</div>
			</div>
