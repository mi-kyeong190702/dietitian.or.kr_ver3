...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#pers_tel,#pers_hp,#lic_print_dt").keyup(function(event){
			$(this).val( $(this).val().replace(/[^0-9:\-]/gi,"") );
		});
		$("#pers_tel,#pers_hp,#lic_print_dt").focusout(function(event){
			$(this).val( $(this).val().replace(/[^0-9:\-]/gi,"") );
		});
	...
	function doCancel(){
		if ( confirm("취소시 비밀번호가 저장되지 않으며, 등록부터 다시 해야 합니다.취소하시겠습니까?")) {
			location.href="km_cancel.do";
		}
	}
	
	// dietitan.js isBoardFile 공통 메소드가 존재하나 본화면에서 해당 js 메소드를 읽어들이지 못해 별도 추가. 
...
<!-- 											<div class="ff_wrap ml130"> -->
<!-- 												<div class="area"> -->
<%-- 													<input type="text" class="input t1 fl w100" id="pers_year"  maxlength="4" value="${personRow.pers_year }"/> --%>
...
<!-- 									</div> -->
									...
									<div class="f_wrap line bb p8">
										<div class="f_field div1">
											...
											<form name="write" enctype="multipart/form-data" method="post" action="km_action.do">
												...
												<ul id="addrUl1">
													<li>
														...
														<div class="area mt5">
															...
															<div class="ml100">
																<div class="area">
																	<input type="text" class="input t1 fl w200" id="code_post1" value="${reportRow.code_post1}" />
																	<a href="javascript:openJusoPopup('2');" class="btn form t1 fl ml5">주소검색</a>
																</div>
																<div class="area mt5">
																	<label for="cs_kitchen_add11" class="ti">기본주소</label>
																	<input type="text" class="input t1 fl w150" id="cs_kitchen_add11" value="${reportRow.cs_kitchen_add11}"  />
													...
													<li class="mt5 pt5 line bt">
														...
														<div class="area mt5">
															...
															<div class="ml100">
																<div class="area">
																	<input type="text" class="input t1 fl w200" id="code_post2" value="${reportRow.code_post2}" />
																	<a href="javascript:openJusoPopup('3');" class="btn form t1 fl ml5">주소검색</a>
																</div>
																<div class="area mt5">
																	<label for="cs_kitchen_add21" class="ti">기본주소</label>
																	<input type="text" class="input t1 fl w150" id="cs_kitchen_add21" value="${reportRow.cs_kitchen_add21}" />
													...
													<li class="mt5 pt5 line bt">
														...
														<div class="area mt5">
															...
															<div class="ml100">
																<div class="area">
																	<input type="text" class="input t1 fl w200" id="code_post3" value="${reportRow.code_post3}" />
													...
													<li class="mt5 pt5 line bt">
														...
														<div class="area mt5">
															...
															<div class="ml100">
																<div class="area">
																	<input type="text" class="input t1 fl w200" id="code_post4" value="${reportRow.code_post4}" />
													...
													<li class="mt5 pt5 line bt">
														...
														<div class="area mt5">
															...
															<div class="ml100">
																<div class="area">
																	<input type="text" class="input t1 fl w200" id="code_post5" value="${reportRow.code_post5}" />
