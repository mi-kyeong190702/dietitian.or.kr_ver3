				...
				<div class="sp_body">
					<div class="tab_2 div5">
						...
						<ul>
							...
							<li><a href="/work/introduction/ki_location_kyeongbuk.do" class="on">대구·경북</a></li>
					...
					<div class="area mt30">
						<h4 class="title bold t2 cm s1 i_b_t2">대구·경북</h4>
						<div class="box t2 mt10 p10">
							<div class="box p10">
								<!-- <div id="map_canvas" class="h350"></div> -->
								<div id="daumRoughmapContainer1739871246556" class="root_daum_roughmap root_daum_roughmap_landing"></div>
							</div>
						</div>
						<h5 class=" text middle bold cg_1 t3 i_b_t2_2 mt30">연락처</h5>
						<ul class="text s1 small mt10 ml10">
							<li class="i_box_t1">대구광역시 중구 대봉로 260, 108동 1901호(대봉동, 센트로팰리스아파트) (우)41950</li>
							<li class="i_box_t1 mt5">TEL : 053-563-6066</li>
							<li class="i_box_t1 mt5">FAX : 053-563-6466 </li>
						</ul>
					</div>
...
<script>
var g_lat = '35.8618867';
var g_lng = '128.6018572';
var geocoder;
var map;
