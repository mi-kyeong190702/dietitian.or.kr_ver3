...
<div class="s_page">
				...
				<div class="sp_body">
					...
					<jsp:include page="activity_select.jsp" flush="false">
					        <jsp:param name="idx" value="10"/>
					</jsp:include>
					<div class="area text s1 mb50">
						<h5 class="title t3 bold i_b_t3 mt50">국제교류</h5>
						<div class="box bgs r5 mt40 ml10 p10 pl20">
							<h6 class="title bold i_b_t6 ">외국영양사협회와의 교류</h6>
						</div>
						
						<div class="box bgs r5 mt40 ml10 p10 pl20">
							<h6 class="title bold i_b_t6 ">AFDA 활동</h6>
						</div>
						
						<div class="box bgs r5 mt40 ml10 p10 pl20">
							<h6 class="title bold i_b_t6 ">ICDA 활동</h6>
						</div>
						
						<div class="box bgs r5 mt40 ml10 p10 pl20">
                            <h6 class="title bold i_b_t6 ">AND 활동</h6>
                        </div>
					</div>
