...
<div class="kb_menu mt20">
	<ul>
		<li class="kb_main" style="width: 25%;"><a href="./kb_health.do"<% if( "kb_health.do".contains(uri) ) { %> class="on" <% } %>>사업소개</a></li>
		<li class="kb_main" style="width: 25%;"><a href="./kb_health_2016.do" <% if( "kb_health_2016.do".contains(uri) ) { %> class="on" <% } %>>2016</a>
			<div class="kb_year">
				<div class="ky_list">
					<ul>
		...
		<li class="kb_main" style="width: 25%;"><a href="./kb_health_2010.do" <% if( "kb_health_2010.do|kb_health_2009.do|kb_health_2006.do".contains(uri) ) { %> class="on" <% } %>>2010~2006</a>
			<div class="kb_year">
				<div class="ky_list">
					<ul>
		...
		<li class="kb_main" style="width: 25%;"><a href="./kb_health_2005.do" <% if( "kb_health_2005.do".contains(uri) ) { %> class="on" <% } %> >2005~2003</a></li>
	</ul>
</div>