			...
			<div class="s_page">
				...
				<div class="sp_body">
					...
					<div class="btn_wrap mt20">
						<ul class="fl">
							<li><a href="/work/business/kb_c_adult_obesity_diet.do?bbs_board_code=67&bbs_category=성인비만식단" class="btn big">목록</a></li>
							<li><a href="#" class="btn big t2">프린트</a></li>
						</ul>
						<ul class="fr">
							<li><a href="/work/business/kb_c_adult_obesity_diet_write.do" class="btn big t4">수정</a></li>
							<li><a href="#" class="btn big t4">삭제</a></li>
							<li><a href="/work/business/kb_c_adult_obesity_diet_write.do" class="btn big t1">글쓰기</a></li>
						</ul>
					</div>
				</div>
			</div>