	...
	<div class="sp_head">
		...
		<div class="sp_navi">
			<ul>
				...
				<li><a href="./kb_nutrition.do">KDA 영양사업</a></li>
					...
					<h5 class="title bold t3 s1 i_b_t3 mt40">정부기관</h5>
						...
						<table class="table t1 text ssmall s1 ca center mt20 mb10">
							...
							<tbody>
								...
								<tr>
									<td  scope="row" class="left bold bgf7">질병관리본부</td>
						...
						<table class="table t1 text ssmall s1 ca center mt20 mb10">
							...
							<tbody>
								<tr>
									...
									<td class="link left"><a title="새창열림" href="http://knhanes.cdc.go.kr" target="_blank">http://knhanes.cdc.go.kr</a></td>
