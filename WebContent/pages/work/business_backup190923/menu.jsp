		...
		<ul class="sm_depth1">
			<li <% if( (file_path.substring(0, 5)).equals("kb_nu")) {%> class="on" <%}%>><a href="/work/business/kb_nutrition.do">영양의 날</a>
				<ul class="sm_depth2">
					...
					<% if( file_path.equals("kb_nutrition") || file_path.equals("kb_nutrition_2007")
							|| file_path.equals("kb_nutrition_2008") || file_path.equals("kb_nutrition_2009")
							|| file_path.equals("kb_nutrition_2010") || file_path.equals("kb_nutrition_2011")
							|| file_path.equals("kb_nutrition_2012") || file_path.equals("kb_nutrition_2013")) {%> class="on" <%}%>>사업소개</a></li>
					<li><a href="/work/business/kb_nutrition_material.do?bbs_board_code=88" 
					<% if( file_path.equals("kb_nutrition_material")
							|| file_path.equals("kb_nutrition_material_write")
							|| file_path.equals("kb_nutrition_material_view")) {%> class="on" <%}%>>자료실</a></li>
				</ul>
			</li>
			<li <% if((file_path.length()  >= 7 && (file_path.equals("kb_farm")
					|| file_path.equals("kb_farm_2004") || file_path.equals("kb_farm_2005")
					|| file_path.equals("kb_farm_2006") || file_path.equals("kb_farm_2007")
					|| file_path.equals("kb_farm_2008") || file_path.equals("kb_farm_2009")
					|| file_path.equals("kb_farm_2010") || file_path.equals("kb_farm_2011")
					|| file_path.equals("kb_farm_2012") || file_path.equals("kb_farm_2013")) )
					|| (file_path.length()  >= 16 && file_path.equals("kb_farm_material"))) {%> class="on" <%}%>><a href="/work/business/kb_farm.do">우리농축수산물 소비촉진사업</a>
				<ul class="sm_depth2">
					<li><a href="/work/business/kb_farm.do" <% if(file_path.length()  >= 7 && (file_path.equals("kb_farm")
							|| file_path.equals("kb_farm_2004") || file_path.equals("kb_farm_2005")
							|| file_path.equals("kb_farm_2006") || file_path.equals("kb_farm_2007")
							|| file_path.equals("kb_farm_2008") || file_path.equals("kb_farm_2009")
							|| file_path.equals("kb_farm_2010") || file_path.equals("kb_farm_2011")
							|| file_path.equals("kb_farm_2012") || file_path.equals("kb_farm_2013"))){%> class="on" <%}%>>사업소개</a></li>
					<li><a href="/work/business/kb_farm_material.do?bbs_board_code=6" 
					<% if(file_path.length()  >= 16 && file_path.equals("kb_farm_material")) {%> class="on" <%}%>>자료실</a></li>
				</ul>
			</li>				
			...
			<li <% if( file_path.length() >= 9 && (file_path.substring(0, 9).equals("kb_health"))) {%> class="on" <%}%>><a href="/work/business/kb_health.do">국민건강증진사업</a>
				<ul class="sm_depth2">
					<li><a href="/work/business/kb_health.do" <% if(file_path.equals("kb_health")
							...
							|| file_path.equals("kb_health_2009") || file_path.equals("kb_health_2010")) {%> class="on" <%}%>>사업소개</a></li>
					<li><a href="/work/business/kb_health_material.do?bbs_board_code=11" 
			...
			<li <% if((file_path.substring(0, 5)).equals("kb_c_") || file_path.equals("kb_clinic")) {%> class="on" <%}%>><a href="/work/business/kb_clinic.do">영양클리닉</a>
				<ul class="sm_depth2">
					...
					<li><a href="/business/qna_board/kb_c_counsel_board.do" <% if(file_path.length() >= 18 && file_path.substring(0, 18).equals("kb_c_counsel_board")) {%> class="on" <%}%>>영양 상담실</a></li>
