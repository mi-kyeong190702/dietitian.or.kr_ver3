...
{
	if(confirm(jQuery.getMessage("COMMON-000028"))){ // 삭제하시겠습니까?
		document.location.href = "ka_sinmungo_paper_board_del.do?idx="+idx;	
	}
}
...
<div class="s_page">
		...
		<ul class="area">
			...
			<form id="sendMail" name="sendMail" action="/ka_send_mail.do">
				<div class="p10 pl15" style="width: 450px;">
					...
					<span style="width: 250px;">
						<input type="checkbox" id="chbox1" name="chbox1" value="관리국">관리국
			...
			<form id="ka_handling" name="ka_handling" action="/ka_handling.do">
				<div class="p10 pl15" style="width: 250px;">
					...
					<input type="hidden" id="idx" name="idx" value="${list.idx }">
					<input type="hidden" id="board_user_id" name="board_user_id" value="${list.board_user_id }">
					<span><input type="submit" class="btn t1" value="처리현황"></span>
				</div>
			</form>
			</li>
			<li class="fl w33p bgw" style="width: 250px;">
	...
	<div class="box t3 text small">
		<ul class="area">
			...
			<li class="fl w33p bgw">
				<div class="p10 pl15">
					<strong class="ib w70 bold cm">회사 이름</strong>
	...
	<ul class="fr">
		<c:choose>
			<c:when test="${sessionScope.user_level==1 }">
				...
				<li><a href="javascript:deleteInfo(${list.idx });" class="btn big t1">삭제</a></li>
			</c:when>
			<c:otherwise>
				<li><a href="/work/archive/ka_sinmungo_paper_board_update.do?idx=${list.idx }" class="btn big t2">수정</a></li>
				<li><a href="ka_sinmungo_paper_board_del.do?idx=${list.idx }" class="btn big t1">삭제</a></li>
			</c:otherwise>
		</c:choose>
	</ul>
</div>
