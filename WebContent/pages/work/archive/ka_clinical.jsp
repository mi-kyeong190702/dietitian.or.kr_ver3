...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">임상</mark>영양</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/archive/ka_clinical.do?bbs_board_code=64&g_userid=<%=work_userid%>" class="cm">임상영양</a></li>
			</ul>
		</div>
	</div>
	<hr />
