...
%>
<!-- 191220 by areum1 -->
<script src="/js/cheditor/cheditor.js" ></script>
<!-- 
...
<script type="text/javascript">
	...
	$(document).on("submit",function(){
		...
		//191220 by areum1
		$("#bbs_contents").val(myeditor.outputBodyHTML());
...
<div class="s_page">
	...
	<hr />
	<form name="ka_sinmungo_write_ok" action="ka_sinmungo_write_ok.do" enctype="multipart/form-data" method="post">
	<div class="sp_body">
			...
			<div class="f_wrap line bb p8">
				<div class="f_field div1">
					...
					<div class="ff_wrap ml120">
						<div class="area">
							<input type="text" name="board_subject" id="board_subject" class="input t1" value="" />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="f_wrap line bb p8">
				<div class="f_field div1">
					...
					<div class="ff_wrap ml120">
						...
						<textarea id="bbs_contents" name="bbs_contents"></textarea>
						
						<!-- //191220 by areum1 -->
						<script type="text/javascript">
						var myeditor = new cheditor();              // 에디터 개체를 생성합니다.
						myeditor.config.editorHeight = '300px';     // 에디터 세로폭입니다.
						myeditor.config.editorWidth = '105%';       // 에디터 가로폭입니다.
						myeditor.inputForm = 'bbs_contents';        // 위에 있는 textarea의 id입니다. 주의: name 속성 이름이 아닙니다.
