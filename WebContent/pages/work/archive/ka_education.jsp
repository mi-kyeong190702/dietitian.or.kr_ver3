...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">영양</mark>교육</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/archive/ka_education.do?bbs_board_code=65&g_userid=<%=work_userid%>" class="cm">영양교육</a></li>
			</ul>
		</div>
	</div>
	<hr />
