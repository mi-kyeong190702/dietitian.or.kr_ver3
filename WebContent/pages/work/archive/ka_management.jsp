...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">급식</mark>경영</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/archive/ka_management.do?bbs_board_code=63&g_userid=<%=work_userid%>" class="cm">급식경영</a></li>
			</ul>
		</div>
	</div>
	<hr />
