...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">보건소</mark>영양사</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/archive/ka_center.do?bbs_board_code=28&g_userid=<%=work_userid%>" class="cm">보건소영양사</a></li>
			</ul>
		</div>
	</div>
	<hr />
	...
	<div class="box t2 mb10 p20">
						<h4 class="title bold s1 cb2">보건소영양사 모임에 오신 것을 환영합니다.<br/>함께 공유하고 싶은 정보 및 어려운점, 나누고 싶은 이야기 등 자유롭게 글을 올려주세요.</h4>
						<div class="area mt10">
							<div class="fl w180">
