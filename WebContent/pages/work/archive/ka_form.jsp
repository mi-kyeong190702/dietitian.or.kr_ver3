...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">업무</mark>서식</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/archive/ka_form.do?bbs_board_code=85&g_userid=<%=work_userid%>" class="cm">업무서식</a></li>
			</ul>
		</div>
	</div>
	<hr />
