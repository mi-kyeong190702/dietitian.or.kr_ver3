...
<div class="s_page">
	<div class="sp_head">
		<div class="sp_title">
			<h3 class="title bold t1 s1 i_b_t1"><mark class="cm">나의 식단 </mark>자랑하기</h3>
		</div>
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/work/archive/ka_recipe.do?bbs_board_code=92&g_userid=<%=work_userid%>" class="cm">나의 식단 자랑하기</a></li>
			</ul>
		</div>
	</div>
	<hr />
