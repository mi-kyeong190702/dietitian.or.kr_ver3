...
<form name="join" id="join" action="/ka_sinmungo.do" method="post">
	<div class="s_page">
		<div class="sp_head">
			<div class="sp_title">
		...
		<div class="box t2 p20">
			<h4 class="title bold s1 cb2">영양사 신문고는 영양사 업무 현장에서 발생하는 어려움을 소통하고 함께 고충 해결방안을 모색하기 위해<br>마련된 공간입니다.<br>질의, 영양사관련 제도 개선, 정책 건의 등 의견개진은 회원게시판을 이용 부탁드립니다.<br>비방, 광고, 개인자료 요청 등의 글은 통보없이 삭제될 수 있습니다.</h4>
		</div>
						...
						<div class="form mt10 line bt bcm">
							<div class="f_wrap line bb p8">
								<div class="f_field div1">
									...
									<div class="ff_wrap ml120">
										<div class="area">
											<input type="text" class="input t1 fl w80" id="pers_name" name="pers_name"/>
										</div>
									</div>
								</div>
							</div>
							<div class="f_wrap line bb p8">
								<div class="f_field div2">
									...
									<div class="ff_wrap ml120 text">
										<div class="area">
											<input type="radio" class="mr5" id="code_sex" name="code_sex" value="1" /> 
							...
							<div class="f_wrap line bb p8">
								<div class="f_field div1">
									...
									<div class="ff_wrap ml120">
										<div class="area">
											<input type="text" class="input t1 fl w200" id="lic_no" name="lic_no" onKeyPress="onlyNumber()" maxlength="6" /> 
										</div>
									</div>
								</div>
							</div>
							<div class="f_wrap line bb p8">
								<div class="f_field div1">
									...
									<div class="ff_wrap ml120">
										<div class="area">
											<input type="text" class="input t1 fl w200" id="email" name="email">
											<label for="email2"	class="fl text ml10 mr10">@</label> 
											<input type="text" class="input t1 fl w150" id="email2" name="email2"/>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="f_field div1">
									...
									<div class="ff_wrap ml120">
										<div class="area">
											...
											<input type="text" class="input t1 fl w100" id="pers_hp" name="pers_hp" size="20" maxlength="12"  style="ime-mode:disabled;width:150px;"  onKeyPress="return digit_check(event);" />
										</div>
									</div>
								</div>
							</div>
								...
								<div class="f_field div1">
									...
									<div class="ff_wrap ml120">
										<ul>
											<li>
												<div class="area">
													<input type="text" class="input t1 fl w100" id="company_name" name="company_name" />
						...
						<div class="form mt10 bt bcm">
							...
							<div class="f_wrap line bb p8">
								<div class="f_field div1">
									...
									<div class="ff_wrap ml120">
										<div class="area">
											<select class="select t2 w200" id="code_user" name="code_user" onChange="javascript:onChangeCodeUse();"></select>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="ff_wrap ml120">
										<div class="area">
											<select class="select t2 w200" id="code_bran" name="code_bran">
												...
												<option value="대전충남세종">대전충남세종</option>
												<option value="전북">전북</option>
												<option value="광주전남">광주전남</option>
