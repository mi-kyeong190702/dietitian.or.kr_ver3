...
<% 
    ...
    String confmKey = "U01TX0FVVEgyMDI1MTIwODE2MDgxMTExNjU0NDM="; // 검색API 승인키
...
<script language="javascript">
    ...
    function setParent(){
        ...
        opener.jusoCallBack2(rtRoadFullAddr, rtAddrPart1, rtAddrDetail, rtAddrPart2, rtEngAddr, rtJibunAddr, rtZipNo, rtAdmCd, rtRnMgtSn, rtBdMgtSn, rtDetBdNmList, rtBdNm, rtBdKdcd, rtSiNm, rtSggNm, rtEmdNm, rtLiNm, rtRn, rtUdrtYn, rtBuldMnnm, rtBuldSlno, rtMtYn, rtLnbrMnnm, rtLnbrSlno, rtEmdNo);
