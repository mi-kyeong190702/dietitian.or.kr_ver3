...
$("document").ready(function(){
    ...
    $("#pDate").datepicker().val(dateStr);
});

function f_Update() {
	var bIndex = ${purchase.bindex};
    var pDate = $("#pDate").val();
    
    location.href="purchaseAction.do?bindex=" + bIndex + "&bpaymentDate=" + pDate + "&crud=U&cd=purchase";
}
	...
	<div class="c_page">
		...
		<div class="cp_contents">
			...
			<table class="table t1 text small center mt10">
				...
				<thead>
				<tr>
					<th colspan="2"scope="col" class="bold cm">주문자정보</th>
				</tr>
				</thead>
				<tbody>
				<tr>
				...
				<tr>
                    ...
                    <td class="left">${purchase.bf_birth }</td>
                </tr>
				<tr>
			...
			<table class="table t1 text small center mt10">
				...
				<tr>
					<td class="bold">주소</td>
					<td class="left"><span>${purchase.bt_Post }</span><br />${purchase.bt_Address }</td>
				</tr>
				<tr>
					<td class="bold">전화번호</td>
			...
			<div class="btn_wrap mt40">
				<ul class="fl">
					<li><a href="purchaseList.do" class="btn big">목록</a></li>
				</ul>
				<c:if test="${purchase.bpayment != 1 }">
					<ul class="fr">
						<li><input type="text" class="input t1 fl w100" id="pDate" name="pDate" value="${pDate}" /></li>
						<li><a href="javascript:f_Update()" class="btn form t1 fl ml5">입금확인</a></li>
					</ul>
				</c:if>
			</div>
