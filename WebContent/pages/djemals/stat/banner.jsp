...
function f_Search() {
	...
	var srch = $("#srch").val();
	location.href="?kind=" + kind + "&stDate=" + stDate + "&endDate=" + endDate + "&srch=" + srch;
}
</script>
<div id="adm_contents">
	<div class="c_page">
		<div class="cp_head">
			<div class="cp_title">
				<h2 class="title t1 s1">배너 클릭통계</h2>
			</div>
			<div class="cp_navi">
				<ul>
		...
		<div class="cp_contents">
					...
					<div class="f_wrap line bb p8">
						<div class="f_field div1">
							...
							<div class="ff_wrap ml80">
								<div class="area">
									<input type="text" class="fl input t1 w70p" id="srch" name="srch" value="${param.srch }"/>
								</div>
							</div>
						</div>
					</div>
			...
			<table class="table t3 text small center mt10">
				...
				<tr>
					...
					<td class="left">${log.banner_name}</td>
					<td>${log.hit}</td>
