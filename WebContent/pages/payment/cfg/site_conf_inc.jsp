...
<%
    ...
    String path = application.getRealPath("/pages/payment");
//     String g_conf_home_dir  = "C:\\Tomcat 5.5\\webapps\\ROOT\\2010_ax_hub_windows_jsp";                  // BIN 절대경로 입력 (bin전까지) 
//     String g_conf_key_dir   = "C:\\Tomcat 5.5\\webapps\\ROOT\\2010_ax_hub_windows_jsp\\bin\\pub.key";    // 공개키 파일 절대경로 
//     String g_conf_log_dir   = "C:\\Tomcat 5.5\\webapps\\ROOT\\2010_ax_hub_windows_jsp\\log";             // LOG 디렉토리 절대경로 입력
	String g_conf_home_dir  = path ;                  // BIN 절대경로 입력 (bin전까지) 
   	String g_conf_key_dir   = path + "\\bin\\pub.key";    // 공개키 파일 절대경로 
	String g_conf_log_dir   = path + "\\pages\\payment\\log";             // LOG 디렉토리 절대경로 입력
    ...
    /* ============================================================================== */
    // String g_conf_gw_url    = "testpaygw.kcp.co.kr"; //협회개발테스트
	...
	//String g_conf_js_url    = "http://pay.kcp.co.kr/plugin/payplus_test_un.js"; //협회개발테스트
	...
	// boolean g_conf_server   = false; //협회개발테스트
    ...
    /* ============================================================================== */
    String g_conf_site_name = "KCP SHOP";
