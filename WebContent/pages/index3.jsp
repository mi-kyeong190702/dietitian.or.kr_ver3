		...
		<div class="visual">
			...
			<div class="v_img img01" >
				...
				<c:forEach items="${bannerAry[0]}" var="main">
					<li class="v_img"><img src="${main.banner_img}" /></li>
				</c:forEach>
				</ul>
				...
				<div class="wrap">
					<div class="v_navi">
						<ul>
							<li class="on"><a href="#"><strong>전문영양사<br />교육센터</strong></a></li>
							<li><a href="#">영양&middot;바른<br />식문화사업</a></li>
							<li><a href="/work/business/kb_waste.do">음식물 쓰레기<br />감량사업</a></li>
							<li><a href="/work/business/kb_health.do">국민건강증진<br />사업</a></li>
						</ul>
					</div>
				</div>
				<div class="ti">
		...
		<div class="wrap main">
			...
			<div class="c_box shortcut">
				<div class="left">
					...
					<div class="cb_body">
						<ul>
							<li class="start"><a href="http://210.127.55.231:8818/"><span class="icon s01"></span>영양교사 정보관<span class="icon arrow"></span></a></li>
							<li><a href="http://210.127.55.231:8820/"><span class="icon s02"></span>학교영양사 정보관<span class="icon arrow"></span></a></li>
						</ul>
					</div>
				</div>
				<div class="right">
				...
				<div class="cb_body">
					<ul>
						<li id="archive_tab" class="archive on">
							...
							<div class="cb_list">
								<ul>
									<li><a href="/kda/views/layout.html?m=kda-archive&amp;f=ka_hotnews"><span class="icon a1"></span>식품영양핫뉴스</a></li>
									<li><a href="/kda/views/layout.html?m=kda-archive&amp;f=ka_management"><span class="icon a2"></span>급식경영</a></li>
									<li><a href="/kda/views/layout.html?m=kda-archive&amp;f=ka_recipe"><span class="icon a3"></span>식단 및 레시피</a></li>
									<li><a href="/kda/views/layout.html?m=kda-archive&amp;f=ka_hygiene"><span class="icon a4"></span>급식위생</a></li>
									<li><a href="/kda/views/layout.html?m=kda-archive&amp;f=ka_education"><span class="icon a5"></span>영양교육</a></li>
									<li><a href="/kda/views/layout.html?m=kda-archive&amp;f=ka_clinical"><span class="icon a6"></span>임상영양</a></li>
									<li><a href="/kda/views/layout.html?m=kda-archive&amp;f=ka_form"><span class="icon a7"></span>업무서식</a></li>
									<li><a href="/kda/views/layout.html?m=kda-archive&amp;f=ka_literature"><span class="icon a8"></span>국내외문헌정보</a></li>
									<li class="noline"><a href="/kda/views/layout.html?m=kda-archive&amp;f=ka_legal"><span class="icon a9"></span>법률정보</a></li>
								</ul>
							</div>
						</li>
						<li id="business_tab" class="business">
							...
							<div class="cb_list">
								<ul>
									<li><a href="/kda/views/layout.html?m=kda-business&amp;f=kb_nutrition"><span class="icon b1"></span>영양의 날</a></li>
									<li><a href="/kda/views/layout.html?m=kda-business&amp;f=kb_farm"><span class="icon b2"></span>우리농축수산물 소비촉진사업</a></li>
									<li><a href="/kda/views/layout.html?m=kda-business&amp;f=kb_waste"><span class="icon b3"></span>음식물쓰레기 감량사업</a></li>
									<li class="noline"><a href="/kda/views/layout.html?m=kda-business&amp;f=kb_health"><span class="icon b4"></span>국민건강 증진사업</a></li>
								</ul>
							</div>
						</li>
					</ul>
			...
			<div class="area">
				<div class="c_familysite">
					...
					<div class="cf_list">
						<ul id="scrollerBanner">
							...
							<li><a href="http://kostat.go.kr/" target="_blank" title="새창으로 이동">통게청</a></li>
				...
				<div class="c_banner">
					<div class="cb_title">
						<h2>배너모음<span class="icon"></span></h2>
						<div class="cb_navi">
					...
					<div  class="cb_list">
						<ul id="banner5">
							...
							<li><a href="${banner5.link_url}" onclick="doClickBanner(${banner5.idx});" <c:if test="${ banner5.link_target != ''}"> target="${banner5.link_target }" title="새창으로 이동" </c:if>  class="mr10 slide"><img src="${banner5.banner_img}" alt="" /></a></li>
							</c:forEach>
						</ul>
					</div>			
					<script>
