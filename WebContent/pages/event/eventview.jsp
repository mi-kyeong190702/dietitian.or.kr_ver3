...
<head>
	...
	<title>대한영양사협회 인(人) & 인(IN) 이벤트</title>
...
/*  	var plusone = "";
	var sns = "";  */
	//alert(document.getElementById("plusoner").checked);
	if(val==1){
		document.getElementById("plusone").style.display="none";
...
/* 		var rowLen2=ta2.rows.length-1;
		for(i=rowLen2;i>2;i--){
		 ...
		 /* document.getElementById("t_idx").value="1"; */ 
	}else{
...
//		document.getElementById("sns").style.display="none";
 		document.getElementById("code_event").value="1";
		document.join.sns_domain.value=""; 
...
<input type="hidden" name="code_pers" id="code_pers" value=""/> -->
	...
	<div class="p_head">
		<h2 class="title t3 cw bold s1 i_b_t6">대한영양사협회 인(人) & 인(IN) 이벤트</h2>
	</div>
	<div class="p_body text ca small">
    	<span class="bold s1 mt20 ml20">
    	<input type="radio" name="event_sel" id="plusoner" value="1" checked onclick="javascript:selEvent(this.value);">협회 人이벤트 : 협회 장기 미가입자 웰컴 이벤트<br/ >
    	<input type="radio" name="event_sel" id="sns_domainr" value="2" onclick="javascript:selEvent(this.value);">협회 IN 이벤트 : 신규 회원 가입자 및 가입 추천한 회원(1+1) 이벤트</span><br/ >
    	
    	<input type="hidden" name="code_event" id="code_event"  value="1"/>
    	<!-- <input type="hidden" name="t_idx" id="t_idx"  value="1"/> -->
		...
		<div class="p20">
			...
			<div class="area">
				<div class="form mt10 line bt bcm">
					...
					<div class="f_wrap line bb p8" style="display:none";>
						<div class="f_field div1">
                    ...
                    <div class="f_wrap line bb p8" style="display:none"; style="display:none";>
						<div class="f_field div1">
                    ...
                    <div class="f_wrap line bb p8">
						<div class="f_field div1">
							<label for="inputid1" class="ff_title i_b"><strong>근무처명</strong></label>
							<div class="ff_wrap ml120">
            ...
            <!-- 협회 IN 이벤트 -->
            <div id="plusone" style="display:block">
			<h5 class=" title bold s1 t3 i_b_t3 mt20">협회 IN이벤트 가입 추천한 회원 정보</h5>
			<table id="t_plusone" class="table t1 text s1 ca center mt20">
				...
				<tbody>		
                    <tr>			
                        ...
                        <td><input name="new_licno" type="text" class="input t1 w100"  value=""></td>
...
<!-- 			<h5 class=" title bold s1 t3 i_b_t3 mt20">협회 人 이벤트</h5> -->
				...
				<div class="box t1 r5 mt10 p10">
					<div class="area h170 scroll text small">
							<table width="580" height="200" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td>
										<b>개인정보 수집·이용에 대한 동의</b><br>
										(사)대한영양사협회가 2024년 회원공감주간 「인人) & 인(IN) 이벤트」 운영을 위하여 아래와 같이 개인정보의 수집·이용에 관한<br>
										사항을 「개인정보 보호법」에 따라 고지하오니 동의하여 주시기 바랍니다.<br>
										· 수집·이용목적 : 2024년 회원공감주간 「인人) & 인(IN) 이벤트」 운영에 필요한 업무로 활용<br>
										· 수집항목 : 성명, 면허번호, 연락처, 근무처명<br>
										· 보유·이용기간 : 본 이벤트 만료일로부터 1개월<br>
										&nbsp;&nbsp;※ 보유기간 이후 개인정보 모두 파기 <br>
										· 동의거부 권리 및 불이익 고지 : 본 개인정보 수집·이용에 대한 동의를 거부하실 수 있으며, 다만 이 경우 2024년 회원공감주간 「인人) & 인(IN) 이벤트」 참여에 제한이 있을 수 있습니다. <br>
												</td>
								</tr>
								</table>
					</div>
					...
					<form name="frmAgree" method="post" action="ke_receipt_application.do">
						...
						예 <input type="checkbox" class="mr5" name="accept" id="accept" value="y" />
						아니오 <input type="checkbox" class="mr5" name="accept" id="accept" value="n" />
					</form>
					</div>
				</div>
			</div>
