...
<%
    ...
    String up_hash       = "";
    String birth_day     = "";
    //String ENC_KEY       =  WorkData.ENC_KEY;// 반드시 외부에 노출되지 않도록 관리하시기 바랍니다.
	/*------------------------------------------------------------------------*/
    /*  :: 전체 파라미터 남기기                                               */
    /*------------------------------------------------------------------------*/
    ...
    <head>
        ...
        <script type="text/javascript" >
            window.onload=function()
            {
                ...
                {
                	//alert(frm.up_hash.value); 
                    opener.document.form_auth.veri_up_hash.value = frm.up_hash.value; // up_hash 데이터 검증을 위한 필드

                    frm.action= "https://cert.kcp.co.kr/kcp_cert/cert_view.jsp";//"https://testcert.kcp.co.kr/kcp_cert/cert_view.jsp"; 
                    frm.submit();
                }
                ...
                {
                    //frm.action="./kcpcert_proc_res.jsp";//"./kcpcert_proc_test.jsp";
                    frm.action="./kcpcert_proc_test.jsp";//"./kcpcert_proc_test.jsp";
                    frm.submit();
                }
                else
                {
