...
<%
    ...
    if( cert_enc_use.equals( "Y" ) )
    {
        if( res_cd.equals( "0000" ) )
        {
            ...
            sbParam.append( "<input type=\"hidden\" name=\"birth\" value=\"" + cc.getKeyValue("birth_day"   )+ "\"/>" );
            sbParam.append( "<input type=\"hidden\" name=\"username\" value=\"" + cc.getKeyValue("user_name"   )+ "\"/>" );
            sbParam.append( "<input type=\"hidden\" name=\"phone\" value=\"" + cc.getKeyValue("phone_no"   )+ "\"/>" );
        }
