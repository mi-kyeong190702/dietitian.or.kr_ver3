...
<div class="s_page">
	<div class="sp_head">
		...
		<div class="sp_navi">
			<ul>
				...
				<li><a href="/member/km_deposit.do" class="cm">기존회원 재가입/입금 확인</a></li>
			</ul>
		</div>
	</div>
	<hr />
	<div class="sp_body">
		...
		<div class="mt30 center">
			...
			<!-- 2022.04.01 주석처리 -->
<%--			<a href="/member/pre_receipt_card.do" class="btn t2 big">영양사카드 결제하기</a>	--%>
			
<!-- 			2020.06.15 박이랑 요청으로 cms입금 타site로 연결함  -->
<%-- 			<%  if (!g_isLogin) { %> --%>
<!-- 					<a href="#" onclick="javascript:alert('로그인이 필요한 화면입니다');" class="btn t3 big">CMS입금</a> -->
<%-- 			<%  } else { %> --%>
